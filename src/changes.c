...
static const unsigned char code_func[SIZE_FUNCTION] = {0x55, 0x48, 0x89, 0xe5, 0x48, 0x83, 0xec, 0x20, 0x89, 0x7d, 0xe4};
static const unsigned char code_end[SIZE_END] = {0xc9, 0xc3};
static const unsigned char code_ret_cst[SIZE_RET_CST] = {0xb8, 0x00, 0x00, 0x00, 0x00};
static const unsigned char code_ret_par[SIZE_RET_PAR] = {0x8b, 0x45, 0xe4};
static const unsigned char code_ret_var[SIZE_RET_VAR] = {0x8b, 0x45, 0x00};
static const unsigned char code_mov_cst_reg[SIZE_MOV_CST_REG] = {0x41, 0xba, 0x00, 0x00, 0x00, 0x00};
static const unsigned char code_mov_var_reg[SIZE_MOV_VAR_REG] = {0x44, 0x8b, 0x55, 0x00};
static const unsigned char code_mov_par_reg[SIZE_MOV_PAR_REG] = {0x44, 0x8b, 0x55, 0xe4};
static const unsigned char code_opr_add_cst[SIZE_BASE_OPR_CST] = {0x41, 0x83, 0xc2, 0x00, 0x00, 0x00, 0x00};
static const unsigned char code_opr_add_var[SIZE_BASE_OPR_VAR] = {0x44, 0x03, 0x55, 0x00};
static const unsigned char code_opr_add_par[SIZE_BASE_OPR_PAR] = {0x44, 0x03, 0x55, 0xe4};
static const unsigned char code_opr_sub_cst[SIZE_BASE_OPR_CST] = {0x41, 0x83, 0xea, 0x00, 0x00, 0x00, 0x00};
static const unsigned char code_opr_sub_var[SIZE_BASE_OPR_VAR] = {0x44, 0x2b, 0x55, 0x00};
static const unsigned char code_opr_sub_par[SIZE_BASE_OPR_PAR] = {0x44, 0x2b, 0x55, 0xe4};
static const unsigned char code_opr_mult_cst[SIZE_MULT_OPR_CST] = {0x45, 0x6b, 0xd2, 0x00, 0x00, 0x00, 0x00};
static const unsigned char code_opr_mult_var[SIZE_MULT_OPR_VAR] = {0x44, 0x0f, 0xaf, 0x55, 0x00};
static const unsigned char code_opr_mult_par[SIZE_MULT_OPR_PAR] = {0x44, 0x0f, 0xaf, 0x55, 0xe4};
static const unsigned char code_mov_reg_var[SIZE_MOV_REG_VAR] = {0x44, 0x89, 0x55, 0x00};
static const unsigned char code_mov_cst_par[SIZE_MOV_CST_PAR] = {0xbf, 0x00, 0x00, 0x00, 0x00};
static const unsigned char code_mov_var_par[SIZE_MOV_VAR_PAR] = {0x8b, 0x7d, 0x00};
static const unsigned char code_mov_par_par[SIZE_MOV_PAR_PAR] = {0x8b, 0x7d, 0xe4};
static const unsigned char code_call[SIZE_CALL] = {0xe8,0x00,0x00,0x00,0x00,0x89,0x45,0x00};
static const unsigned char code_zret_cmpl[SIZE_CMPL] = {0x41, 0x83, 0xfa, 0x00};
static const unsigned char code_zret_jne[SIZE_JNE] = {0x75, 0x07};
